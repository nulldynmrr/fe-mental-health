...
const AddJournalCard = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="border border-blue-400 bg-blue-50 rounded-md flex flex-col items-center justify-center text-blue-500 hover:bg-blue-100 transition shadow-sm cursor-pointer"
    >
